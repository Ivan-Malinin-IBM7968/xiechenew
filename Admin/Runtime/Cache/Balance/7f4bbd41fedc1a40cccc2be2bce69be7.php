...
<tr>
<?php if(is_array($data["Membercoupon"])): $i = 0; $__LIST__ = $data["Membercoupon"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><td><?php echo ($vo["shop_name"]); ?></td>
...
<td>
	<a href="__URL__/opencoupon/shop_id/<?php echo ($vo["shop_id"]); ?>" >可开票订单数量<?php echo ($vo["open_count"]); ?></a>
</td>
<td>
	<a href="__URL__/paycoupon/shop_id/<?php echo ($vo["shop_id"]); ?>" >可打款订单数量<?php echo ($vo["pay_count"]); ?></a>
</td>
<td>
