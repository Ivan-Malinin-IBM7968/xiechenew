...
<script language="JavaScript">
    <!--
    function fleshMenu(){
        ThinkAjax.send('__URL__/fleshMenu','ajax=1');
...
<div id="main" class="main" >
    ...
    <div class="content" >
        ...
        <div class="operate" >
            ...
            <div class="impBtn hMargin fLeft shadow" ><input type="button" id="" name="sort" value="刷新" onclick="fleshMenu()" class="sort imgButton"></div>
            <!-- 查询区域 -->
            <div class="fRig">
