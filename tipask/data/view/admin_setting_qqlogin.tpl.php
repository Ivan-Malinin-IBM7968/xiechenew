...
<div style="width:100%; height:15px;color:#000;margin:0px 0px 10px;">
...
</table><? } ?><form action="index.php?admin_setting/qqlogin<?=$setting['seo_suffix']?>" method="post">
    <table cellspacing="1" cellpadding="4" width="100%" align="center" class="tableborder">
        ...
        <tr>
            ...
            <td>
                <input type="radio" value="1" name="qqlogin_open" <? if($setting['qqlogin_open']) { ?>checked<? } ?>/>是&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" value="0" name="qqlogin_open" <? if(!$setting['qqlogin_open']) { ?>checked<? } ?>/>否
            </td>
        </tr>
        <tr>
