...
<tr>
        <td class="altbg1" width="150"><strong><?=$usergroup['groupid']?></strong></td>
        ...
        <td class="altbg1"><? if($usergroup['groupid']>26 ) { ?><a href="javascript:if(window.confirm('确认删除?'))window.location='index.php?admin_usergroup/remove/<?=$usergroup['groupid']?><?=$setting['seo_suffix']?>'">删除</a><? } else { ?>不能删除<? } ?>        </td>
</tr>
<? } } ?>
