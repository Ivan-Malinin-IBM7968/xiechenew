...
<div style="width:100%; height:15px;color:#000;margin:0px 0px 10px;">
    ...
    <table cellspacing="1" cellpadding="4" width="100%" align="center" class="tableborder">
        ...
        <tr>
            <td colspan="2">
                1、“支付宝”(http://www.alipay.com)是中国领先的网上支付平台，由全球最佳 B2B 公司阿里巴巴公司创建，为 Tipask 用户提供财富充值平台。你只需进行简单的设置，即可使系统内容和人气，真成为除广告收入外的重要利润来源，从而实现网站的规模化经营。<br />
                ...
                4、除 Tipask 官方网站或官方论坛另行通知以外，Tipask 提供的支付宝支付服务每笔交易收取 1.5% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Tipask 官方网站或官方论坛提供的信息为准。<br />
                5、你使用支付宝服务是建立在完全自愿的基础上，除 Tipask 因主观恶意的因素造成的资金损失以外，Tipask官方不对因使用此功能造成的任何损失承担责任。<br />
        ...
        <tr>
            ...
            <td>
                <input class="radio" type="radio" <? if(1==$setting['recharge_open'] ) { ?>checked<? } ?>  value="1" name="recharge_open" />是&nbsp;&nbsp;
                       <input class="radio" type="radio" <? if(0==$setting['recharge_open'] ) { ?>checked<? } ?>  value="0" name="recharge_open" />否
            </td>
        </tr>
        <tr>
