...
<tr id="regular_view">
    ...
    <div style="width: 200px; float: left;">
        ...
        <div style="width: 200px; float: left;">
            <input name="regular_code[]" value="category/recommend"  <? if(false!==strpos($group['regulars'],'category/recommend')) { ?>checked<? } ?>  class="checkbox" type="checkbox">推荐专题
        </div>
        <div style="width: 200px; float: left;">
        ...
        <div style="width: 200px; float: left;">
            <input name="regular_code[]" value="user/famouslist"  <? if(false!==strpos($group['regulars'],'user/famouslist')) { ?>checked<? } ?>  class="checkbox" type="checkbox">推荐之星
        </div>
        <div style="width: 200px; float: left;">
            <input name="regular_code[]" value="index/taglist"  <? if(false!==strpos($group['regulars'],'index/taglist')) { ?>checked<? } ?>  class="checkbox" type="checkbox">标签大全
        </div>
         <div style="width: 200px; float: left;">
        ...
        <div style="width: 200px; float: left;">
            <input name="regular_code[]" value="question/add,question/tagask"  <? if(false!==strpos($group['regulars'],'question/add,question/tagask')) { ?>checked<? } ?>  class="checkbox" type="checkbox">提问题
        </div>
        <div style="width: 200px; float: left;">
        ...
        </div><? if(6!=$group['groupid']) { ?>        <div style="width: 200px; float: left;">
    ...
    <? if(6!=$group['groupid']) { ?>    <tr id="regular_user">
 <td class="altbg1" width="18%">
...
<input name="regular_code[]" value="user/register"  <? if(false!==strpos($group['regulars'],'user/register')) { ?>checked<? } ?>  class="checkbox" type="checkbox">注册用户
        ...
        <div style="width: 200px; float: left;">
            <input name="regular_code[]" value="user/recharge,ebank/aliapyback,ebank/aliapytransfer"  <? if(false!==strpos($group['regulars'],'user/recharge,ebank/aliapyback,ebank/aliapytransfer')) { ?>checked<? } ?>  class="checkbox" type="checkbox">财富充值
        </div>
        <div style="width: 200px; float: left;">
        ...
        <div style="width: 200px; float: left;">
            <input name="regular_code[]" value="user/favorite,question/addfavorite"  <? if(false!==strpos($group['regulars'],'user/favorite,question/addfavorite')) { ?>checked<? } ?>  class="checkbox" type="checkbox">我的收藏
        </div>
        <div style="width: 200px; float: left;">
...
<td class="altbg1" width="18%">
    <input name="chkGroup" value="regular_question"  class="checkbox" type="checkbox" onclick="selectCell(this);">问题相关（前台）
        ...
        <td class="altbg2">
            ...
            <!--
            <div style="width: 200px; float: left;">
                <input name="regular_code[]" value="question/govote"  <? if(false!==strpos($group['regulars'],'question/govote')) { ?>checked<? } ?>  class="checkbox" type="checkbox">问题投票
            </div>
            -->
            <div style="width: 200px; float: left;">
...
<tr id="regular_message">
    ...
    <td class="altbg2">
        ...
        <div style="width: 200px; float: left;">
            <input name="regular_code[]" value="message/remove"  <? if(false!==strpos($group['regulars'],'message/remove')) { ?>checked<? } ?>  class="checkbox" type="checkbox">删除消息
        </div>
    </td>
</tr><? if(1==$group['grouptype']) { ?><tr id="regular_setting">
    <td class="altbg1" width="18%">
...
<tr id="regular_manage">
    ...
    <td class="altbg2">
        <div style="width: 200px; float: left;">
            <input name="regular_code[]" value="admin_category/default,admin_category/add,admin_category/edit,admin_category/view,admin_category/remove,admin_category/reorder"  <? if(false!==strpos($group['regulars'],'admin_category/default,admin_category/add,admin_category/edit,admin_category/view,admin_category/remove,admin_category/reorder')) { ?>checked<? } ?>  class="checkbox" type="checkbox">分类管理
        </div>
        <div style="width: 200px; float: left;">
            <input name="regular_code[]" value="admin_question/default,admin_question/searchquestion,admin_question/searchanswer,admin_question/removequestion,admin_question/removeanswer,admin_question/edit"  <? if(false!==strpos($group['regulars'],'admin_question/default,admin_question/searchquestion,admin_question/searchanswer,admin_question/removequestion,admin_question/removeanswer,admin_question/edit')) { ?>checked<? } ?>  class="checkbox" type="checkbox">问题管理
        </div>
        <div style="width: 200px; float: left;">
    ...
    <? } ?>    <? } ?></tbody>
</table><? if(6!=$group['groupid'] && $group['grouptype']!=1) { ?><table cellspacing="1" cellpadding="4" width="100%" align="center" class="tableborder">
<tr class="header">
...
</table><? } ?>    <input type="submit" class="button" name="submit" value="提交" />
</form>
<br>
