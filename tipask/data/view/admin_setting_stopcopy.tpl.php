...
<td class="altbg2">
<input class="radio"  type="radio"  <? if(1==$setting['stopcopy_on'] ) { ?>checked<? } ?>  value="1" name="stopcopy_on"><label for="yes">是</label>&nbsp;&nbsp;
<input class="radio"  type="radio"  <? if(0==$setting['stopcopy_on'] ) { ?>checked<? } ?> value="0" name="stopcopy_on"><label for="no">否</label>
</td>
</tr>
<tr>
