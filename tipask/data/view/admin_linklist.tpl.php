...
<td width="15%" class="altbg2" align="center"><img src="<?=SITE_URL?>css/common/admin/edit.png" onclick="document.location.href='index.php?admin_link/edit/<?=$link['id']?><?=$setting['seo_suffix']?>'"></td>
<td width="10%" class="altbg1" align="center"><img src="<?=SITE_URL?>css/common/admin/remove.png" onclick="remove(<?=$link['id']?>);"></td>
</tr>
</table>
</li>
<? } } ?>
