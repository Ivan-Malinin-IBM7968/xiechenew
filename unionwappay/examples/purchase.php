...
$req['orderDescription']	= $coupon_name_str;// 订单描述(可选)
$req['orderTime']   		= date("YmdHis"); // 交易开始日期时间yyyyMMddHHmmss
$req['orderTimeout']   		= ""; // 订单超时时间yyyyMMddHHmmss(可选)
$req['orderNumber'] 		= date('YmdHis') ."-".$orderNumber; //date("YmdHiss")订单号(商户根据自己需要生成订单号)
$req['orderAmount'] 		= $coupon_amount*100; // 订单金额
