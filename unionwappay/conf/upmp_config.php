...
class upmp_config
{
    ...
    static $mer_id     				= "880000000000665"; // 商户号
    static $security_key    		= "qQxrXU3ZAH7RUTilTwIKbBUhDHXm59ue"; // 商户密钥
    static $mer_back_end_url     	= "http://www.xieche.com.cn/unionwappay/notify_url.php"; // 后台通知地址
