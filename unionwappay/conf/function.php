...
function save_unionmembercoupon_pay($membercoupon_ids,$qid,$traceNumber,$orderAmount,$respMsg,$respTime,$is_return){
	global $mysql;
	$now = time();
	$sql = "INSERT INTO xc_chinapaycouponpay SET membercoupon_ids='".$membercoupon_ids."' , qid='{$qid}' , traceNumber='{$traceNumber}' , orderAmount='{$orderAmount}' , respMsg='{$respMsg}' , respTime='{$respTime}' , create_time={$now} , is_return={$is_return} , is_app=1";
