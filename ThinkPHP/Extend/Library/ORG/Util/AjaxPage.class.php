	...
	*/
    public function show_app() {
       if(0 == $this->totalRows) return '';
		...
		//上一页
        if ($upRow>0){
            $upPage="<div id='prev-page' class='page-trigger'><a id='big' href='javascript:".$this->ajax_func."(".$upRow.")'>".$this->config['prev']."</a></div>";
        }else{
            $upPage="<div id='prev-page' class='page-trigger'><a href='###'>".$this->config['prev']."</a></div>";
        }
		...
		//下一页
		if ($downRow <= $this->totalPages){
            $downPage="<div id='next-page' class='page-trigger'><a id='big' href='javascript:".$this->ajax_func."(".$downRow.")'>".$this->config['next']."</a></div>";
        }else{
            $downPage="<div id='next-page' class='page-trigger'><a id='big' href='###'>".$this->config['next']."</a></div>";
        }
        // << < > >>
		/*
        if($nowCoolPage == 1){
            ...
            $preRow =  $this->nowPage-$this->rollPage;
            $prePage = "<div id='prev-page' class='page-trigger'><a id='big' href='javascript:".$this->ajax_func."(".$preRow.")'>上".$this->rollPage."页</a></a>";
            $theFirst = "<li id='totle-page'><a id='big' href='javascript:".$this->ajax_func."(1)' >".$this->config['first']."</a></li>";
        }
        if($nowCoolPage == $this->coolPages){
            $nextPage = "";
            $theEnd="";
            ...
            $nextRow = $this->nowPage+$this->rollPage;
            $theEndRow = $this->totalPages;
            $nextPage = "<div id='prev-page' class='page-trigger'><a id='big' href='javascript:".$this->ajax_func."(".$nextRow.")' >下".$this->rollPage."页</a></div>";
            $theEnd = "<li id='totle-page'><a id='big' href='javascript:".$this->ajax_func."(".$theEndRow.")' >".$this->config['last']."</a></li>";
        }*/
        // 1 2 3 4 5
        /*$linkPage = "";
        for($i=1;$i<=$this->rollPage;$i++){
