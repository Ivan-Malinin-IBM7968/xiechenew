...
$bidorder_id = $_GET['bidorder_id'];
$insurance_info = get_insurance_info($bidorder_id);

$subject		= $insurance_info['pay_subject'];			//产品名称
$out_trade_no	= "b_".$bidorder_id;			//请与贵网站订单系统中的唯一订单号匹配
$total_fee		= $insurance_info['loss_price'];			//订单总金额
$out_user		= $insurance_info['uid'];			//商户系统中用户唯一标识、例如UID、NickName
/**
