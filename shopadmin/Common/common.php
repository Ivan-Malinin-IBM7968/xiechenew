...
function memo($id,$memo='') {
    ...
    $info = "<span id='memotextarea_".$id."' ".$display_1."><textarea name='memo_".$id."' id='memo_".$id."' cols='15'>".$memo."</textarea><a href='###' onclick='savememo(".$id.");'>修改</a></span><span id='memotext_".$id."' ".$display_2."><a href='###' onclick='memo(".$id.")'>备注</a>";
    return $info;
}
