...
function selectcity(idname)
{
		...
		citybox = document.userinfo.city;
        if(tCity != null)
		{
                       citybox = document.userinfo.city;
                       if (tCity.length>1){
                          ...
                          for(i = 0; i < tCity.length; i++)
                            {
                             ...
                             if (str==idname){
                                 citybox.options[i+1].selected="true";
                             }
                          }
                          citybox.length = i+1;
                        }
