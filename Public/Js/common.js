...
/*modify by yyc */
function addworkhours(id){
	location.href = APP+"/workhours/addworkhours/shop_id/"+id;
}
function listtimesale(id){
	location.href = APP+"/timesale/listtimesale/id/"+id;
}

function listworkhours(id){
	location.href = APP+"/workhours/listworkhours/shop_id/"+id;
}
function addproduct(id){
	location.href = APP+"/product/addproduct/shop_id/"+id;
}
function listservice(id){
	location.href = APP+"/product/listservice/shop_id/"+id;
}
/* modify by yyc --end*/
function output(){
