...
<div>
	<form action="" method="" name="">
		...
		<input type="button" name="button" id="button" value="button" onclick="new Calendar().show(this.form.control_date);" />
	</form>
</div>
添加showCalendar()主调方法后可以简化
<div>
	<form action="" method="" name="">
		<span>日期查询：</span>
		<input name="control_date" type="text" id="control_date" size="10" maxlength="10" onclick="showCalendar(this);" readonly="readonly" />
		<input type="button" name="button" id="button" value="button" onclick="showCalendar(this.form.control_date);" />
	</form>
</div>
-->
*/
...
__ci.document.writeln('<title>Please select date<\/title>');
...
__ci.document.writeln('th {font-size:12px;font-weight:normal;background-color:#FFFFFF;height:16px;line-height:16px;}');
__ci.document.writeln('th.theader {font-weight:normal;background-color:#666666;color:#FFFFFF;width:24px;}');
__ci.document.writeln('select.year {width:64px;cursor:pointer}');
__ci.document.writeln('select.month {width:60px;cursor:pointer}');
__ci.document.writeln('td {font-size:12px;text-align:center;height:16px;line-height:16px;cursor:pointer}');
...
__ci.document.writeln('input.b:hover {background-color:#DEDEDE;}');
__ci.document.writeln('-->');
