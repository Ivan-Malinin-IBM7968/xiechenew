...
class Image {
     ...
     * @throws ThinkExecption
      +----------------------------------------------------------
     */
 	static public function water($source, $water, $savename=null, $alpha=80, $position=null,$x=null,$y=null) {
        //检查文件是否存在
...
//         $posX = $sInfo["width"] - $wInfo["width"];
    ...
    static function buildImageVerify($length=4, $mode=1, $type='png', $width=48, $height=22, $verifyName='verify') {
        ...
        for ($i = 0; $i < $length; $i++) {
			...
			imagettftext($im, mt_rand(25, 30), 0, $i * 20 + 15, mt_rand(35, 40), $stringColor, $fontface, $randval{$i});
